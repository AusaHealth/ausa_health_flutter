      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            }, color: Colors.white, textColor: Colors.orange,),
            const SizedBox(width: 16),
            AusaButton(text: 'Take Tests', onPressed: () {
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Text(test.name, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600),),
            ],
          ),
        ),
          if (test.isDone) Positioned(
            top: 0,
            right: 0,
  ...
  Widget build(BuildContext context) {
    final Color bg =
        selected
            ...
            : Colors.white;
    final Color ic = iconColor ?? Colors.black;
    return Material(
      color: bg,
      ...
      child: InkWell(
        ...
        child: Padding(
          padding: const EdgeInsets.all(8),
          child: Icon(icon, color: selected ? ic : Colors.black, size: 24),
        ),
      ),
    );
  }
