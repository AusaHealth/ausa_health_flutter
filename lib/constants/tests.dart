...
Map<TestType, Test> tests = {
  TestType.bloodPressure: Test(
    ...
    instruction: "Place your finger at the indicated spot.",
    instructionType: TestInstructionType.text,
    instructions: [
      TestInstruction(
        title: 'Blood Pressure',
        content: "Place your finger at the indicated spot.",
        image: 'assets/images/test_ins.png',
      ),
    ],
  ),
  TestType.heartSignal: Test(
    type: TestType.heartSignal,
    name: 'Heart Signal',
  ...
  TestType.bloodSaturation: Test(
    type: TestType.bloodSaturation,
    name: 'Blood Saturation',
    description: 'Blood Saturation',
  ...
  TestType.bodyImage: Test(
    type: TestType.bodyImage,
    name: 'Body Image',
